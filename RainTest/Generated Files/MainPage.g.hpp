...
void ::App1::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
    ...
    case 1:
        {
            this->ellipse = safe_cast<::Windows::UI::Xaml::Shapes::Ellipse^>(__target);
        }
        break;
    case 2:
        {
    ...
    case 3:
        {
            ...
            (safe_cast<::Windows::UI::Xaml::Controls::Button^>(this->button))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::App1::MainPage::*)
